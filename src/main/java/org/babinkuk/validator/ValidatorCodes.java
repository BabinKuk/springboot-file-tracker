...
public enum ValidatorCodes {
	...
	ERROR_CODE_FILE_DESC_EMPTY("error_code_file_desc_empty"),
	ERROR_CODE_FILE_INVALID("error_code_file_invalid"),
	ERROR_CODE_ACTION_INVALID("error_code_action_invalid"),
	ERROR_CODE_FILE_DESC_ALREADY_EXIST("error_code_file_desc_already_exist"),
	ERROR_CODE_FILE_ID_NOT_FOUND("error_code_file_id_not_found"),
	ERROR_CODE_FILE_DESC_NOT_FOUND("error_code_file_desc_not_found"),
